...
class Ui_MainWindow(object):
    ...
    def render(self):
        ...
        self.displayAll(solveN(kernel.objects, concentrated.objects, self.graphicsView.left_sealing, self.graphicsView.right_sealing),
                        ...
                        kernel.objects, left=self.graphicsView.left_sealing, right=self.graphicsView.right_sealing, concentrateds = concentrated.objects)
    ...
    def open_file(self):
        ...
        if fname[0] != '':
            ...
            #sealings
                if all['sealings'][0] == True:
                    ...
                    self.formLayout_4.itemAt(1, QtWidgets.QFormLayout.FieldRole).widget().setCheckState(0)
                    self.graphicsView.left_sealing = False
                if all['sealings'][1] == True:
                    self.formLayout_4.itemAt(2, QtWidgets.QFormLayout.FieldRole).widget().setCheckState(2)
                    self.graphicsView.right_sealing = True
                else:
                    self.formLayout_4.itemAt(2, QtWidgets.QFormLayout.FieldRole).widget().setCheckState(0)
                    self.graphicsView.rigth_sealing = False
        ...
        print('TRUTH', self.graphicsView.left_sealing, self.graphicsView.right_sealing)
